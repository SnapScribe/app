    ...
    <Card className="p-5 rounded-2xl w-[360px] m-3 self-center">
      <Animated.View>
        <Image
          ...
          source={
            typeof currentCard.image === 'string' ? { uri: currentCard.image } : currentCard.image
          }
        />
      </Animated.View>
      ...
      <Animated.View className="absolute left-3 top-4">
        <View className="px-3 py-2 rounded-md">
          <Text className="font-semibold text-typography-800">← {currentCard.guess1}</Text>
        </View>
      </Animated.View>
      ...
      <Animated.View className="absolute right-3 top-4">
        <View className="px-3 py-2 rounded-md">
          <Text className="font-semibold text-typography-800">{currentCard.guess2} →</Text>
        </View>
      </Animated.View>
    </Card>
  );
