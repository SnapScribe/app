...
const WordCard = ({ word }: IWordCard) => {
  ...
  return (
    <>
      <WordModal showModal={showModal} setShowModal={setShowModal} word={word} />
      ...
      <Pressable
        ...
        <HStack className="items-center">
          ...
          <VStack className="flex-1" space="xs">
            <Text className="text-typography-900 font-dm-sans-medium">{word.name}</Text>
            <Text className="text-typography-700 font-dm-sans-regular">{word.description}</Text>
            <Text className="text-typography-400 font-dm-sans-regular">{word.createdAt}</Text>
          </VStack>
        </HStack>
      </Pressable>
    </>
